...
![1](https://cloud.githubusercontent.com/assets/3950285/22853674/c830411e-f097-11e6-9c8a-adf0df8a89d9.png)
...
![2](https://cloud.githubusercontent.com/assets/3950285/22853679/dc5e98c0-f097-11e6-90a0-029318be6a1b.png)

JavaScript中的1号对象产生了，不妨把它叫做No. 1。
这个No. 1对象可不得了，它是真正的万物始祖。它拥有的性质，是所有的对象都有的。
__proto__是什么呢？是“生”的意思，或者叫做**继承**。
...
![3](https://cloud.githubusercontent.com/assets/3950285/22853696/287cb110-f098-11e6-8c78-521dac52704b.png)
...
![4](https://cloud.githubusercontent.com/assets/3950285/22853709/45fc9ca0-f098-11e6-93f3-d8856cf12c3d.png)
...
![5](https://cloud.githubusercontent.com/assets/3950285/22853713/5faa7c62-f098-11e6-9386-5847adb5a921.png)

（注：__proto__写起来太麻烦了，后面我们用[p]来代替）

当然了，和Object一样，这些机器也需要各自有一个模板对象，也就是它们的prototype属性指向的那个对象。显然它们的模板对象应该是继承自No. 1对象的，即

![6](https://cloud.githubusercontent.com/assets/3950285/22853716/68b02578-f098-11e6-9156-0783f5fbdc97.png)
...
![7](https://cloud.githubusercontent.com/assets/3950285/22853724/7e95bd6c-f098-11e6-8f97-c31ff1a71168.png)
...
从上面的Bird和makeBirdFly的定义可以看出：实际上，制造对象的机器和做事情的机器没什么明显区别，不同的只是它们的使用方式。在两种情况下，它们分别被叫做**构造函数**和**普通函数**。
...
![8](https://cloud.githubusercontent.com/assets/3950285/22853727/a3bb8324-f098-11e6-93fb-30f13ad134ad.png)
...
![9](https://cloud.githubusercontent.com/assets/3950285/22853729/b06b9a64-f098-11e6-9f92-56187773e1e7.png)

用同样的方法，造物主造出了一个立体得多的JavaScript世界。

然而这样还不够。虽然那些纯对象现在充满了层次感，但是那些机器对象之间的关系还是扁平的：

![10](https://cloud.githubusercontent.com/assets/3950285/22853731/b94a0e68-f098-11e6-9e34-e813b060320c.png)

那又该怎么办呢？其实用类似的办法就行了：

![11](https://cloud.githubusercontent.com/assets/3950285/22853734/c0f79540-f098-11e6-9dd0-8697063cab0d.png)
...
![12](https://cloud.githubusercontent.com/assets/3950285/22853736/d1b479c0-f098-11e6-92d8-ba4f91b487c0.png)
